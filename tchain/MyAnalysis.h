...
// Sat May 29 10:19:46 2021 by ROOT version 6.20/04
// from TTree Events/Events
// found on file: dyee012j_5f_NLO_UNLOPS_26052021.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[4286];   //[nGenPart]
   Float_t         GenPart_mass[4286];   //[nGenPart]
   Float_t         GenPart_phi[4286];   //[nGenPart]
   Float_t         GenPart_pt[4286];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[4286];   //[nGenPart]
   Int_t           GenPart_pdgId[4286];   //[nGenPart]
   Int_t           GenPart_status[4286];   //[nGenPart]
   Int_t           GenPart_statusFlags[4286];   //[nGenPart]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("dyee012j_5f_NLO_UNLOPS_26052021.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("dyee012j_5f_NLO_UNLOPS_26052021.root");
      }
