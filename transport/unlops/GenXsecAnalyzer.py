...
# USAGE : python calculate_neg_events.py
...
## File location ##
#Path = "UNLOPS_log/"    ## only need to change this line
Path = "/home/sobarman/t3store3/Generator/UNLOPS/Analysis/date_18112021/unlops_v2/log_files/"
#Path = "/home/sobarman/t3store3/Generator/UNLOPS/Analysis/date_18112021/FXFX_log/"
...
for i in filelist:
	if i.endswith(".log"):
			...
			#print "Reading file name :"+str(f)
				...
				if line.startswith("After filter: final cross section = 0.000e+00 +- 0.000e+00 pb"):
					myLines5.append(line)
					print "Buggy file with cross section = 0"+str(f)
				if line.startswith("After filter: final cross section = -nan +- -nan pb"):
					myLines6.append(line)
					print "Buggy file with cross section = nan"+str(f)
...
print "\n"
print "#############################"
for a,b in enumerate(myLines5):
        a +=1
        print "File Number : "+str(a)+" : "+b

print "\n"
print "#############################"
for c,d in enumerate(myLines6):
        c +=1
        print "File Number : "+str(c)+" : "+d
